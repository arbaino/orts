                                ...
                                <div class="basic-form">
                                     <form action="../../controller/RepairCaseSaveAction.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default " name="contact_person" placeholder="Contact Person">
                                        </div>
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Phone No.</p>
                                            <input type="text" class="form-control input-default " name="phone_number"  placeholder="Phone No.">
                                        </div>
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Bad Condition</p>
                                            <input type="text" class="form-control input-default " name="bad_condition"  placeholder="Bad Condition">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default " name="IMEI"  placeholder="IMEI">
                                        </div>
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Phone Password</p>
                                            <input type="text" class="form-control input-default " name="phone_password"  placeholder="Phone Password">
                                        </div>
