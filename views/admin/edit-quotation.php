                                ...
                                <div class="basic-form">
                                    ...
                                    <form action="../../controller/QuotationSaveAction.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default " value="<?=$row['customer_name']?>" placeholder="Customer Name" readonly/>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <tbody>
                                                ...
                                                $totalPrice = 0;
                                                    foreach($lineItem as $item){
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text" name="lineItem[sparepart][]" value="'.$item['sparepart'].'" style="width:100%;" />
                                                            </td>
                                                            <td>
                                                                <input type="text" name="lineItem[price][]" value="'.$item['price'].'" style="width:100%;" />
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                    ...
                                                    for($i = 1; $i <= (5 - sizeof($lineItem)) ;$i++){
                                                        echo '<tr>
                                                    
                                                        <td>
                                                            <input type="text" name="lineItem[sparepart][]" style="width:100%;" />
                                                        </td>
                                                        <td>
                                                            <input type="text" name="lineItem[price][]" style="width:100%;" />
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
